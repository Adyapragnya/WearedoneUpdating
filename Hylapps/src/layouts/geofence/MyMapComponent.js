    ...
    const checkVesselsInGeofences = () => {
      ...
      vessels.forEach((vessel) => {
        ...
        polygonGeofences.forEach((geofence) => {
          ...
          if (isInside) {
            overlappingGeofences.push(`${geofence.geofenceName} || ${geofence.geofenceType ||  'Polygon'} || ${geofence.seaport}`);
            isInsideAnyGeofence = true;
          }
        });
        ...
        circleGeofences.forEach((geofence) => {
          ...
          if (isInsideCircle) {
            overlappingGeofences.push(`${geofence.geofenceName} || ${geofence.geofenceType || 'Circle'} || ${geofence.seaport} `);
            isInsideAnyGeofence = true;
          }
        });

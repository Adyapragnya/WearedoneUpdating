...
const CreateOrganization = () => {
  ...
  const [adminContactNumber, setAdminContactNumber] = useState('9876543210');
      ...
      <form className="alert-form" onSubmit={handleSubmit}>
        ...
        <div className="two-column">
          ...
          {/* <label>
            ...
            <input disabled type="text" value={adminContactNumber} onChange={(e) => setAdminContactNumber(e.target.value)} placeholder="Enter Admin Contact Number" />
          </label> */}
        </div>
